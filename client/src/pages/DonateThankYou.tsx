    ...
    <div style={{ minHeight: "100vh", background: "#050505", color: cream, fontFamily: "'EB Garamond', Georgia, serif" }}>
      ...
      <div style={{ maxWidth: "600px", margin: "0 auto", padding: "5rem 2rem 4rem", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "0.75rem", flexWrap: "wrap", marginBottom: "3rem" }}>
          <a
            href={`https://x.com/intent/tweet?text=I%20just%20supported%20The%20Vault%20Investigates%20%E2%80%94%20independent%20journalism%20exposing%20poverty%20fraud.%20Reader-supported%2C%20no%20corporate%20backing.&url=${encodeURIComponent("https://vet.thevaultinvestigates.cloud/donate")}`}
            target="_blank"
